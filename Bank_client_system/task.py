...
# The task was to write a python programme that simulates a bank client system. 
# The bank has clients, which have a balance.
# The bank should be able to add clients, deposit, withdraw and transfer money between clients.
# The bank should also be able to print out the clients' account statements.
# The bank should also be able to transfer money between clients of different banks.
